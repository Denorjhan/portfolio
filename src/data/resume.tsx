  ...
  work: [
    {
      ...
      description: [
        ...
        "Developed automated evaluation pipelines and monitoring for AI quality, implementing systematic testing to identify hallucinations, model drift, bias, context bloat, and orchestration errors.",
    ...
    },
    {
      ...
      logoUrl: "/americanexpress.webp",
      start: "May 2020",
      end: "October 2022",
      description: [
        "Implemented comprehensive GPU monitoring and cost optimization for cloud infrastructure, building real-time dashboards and Kubernetes auto-scaling policies that reduced compute costs by $120k annually while maintaining <200ms p95 inference latency across global production environment serving 100k+ daily requests.",
        "Engineered automated GPU provisioning platform using Terraform and Python SDKs/APIs, enabling 5+ ML teams to self-service deploy training environments in under 10 minutes vs. 2-day manual workflow, reducing AI infrastructure team load by 45%.",
    ...
    {
      company: "Chronograph",
      href: "https://chronograph.pe",
      badges: [],
      location: "Remote",
      title: "Software Engineer",
      logoUrl: "/chronograph.webp",
      start: "August 2018",
      end: "September 2019",
      description: [
        "Implemented comprehensive unit and regression testing with Pytest for a big data analytics engine.",
