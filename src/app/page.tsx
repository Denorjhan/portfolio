  ...
  return (
    <TracingBeam className="px-6">
      <main className="min-h-dvh flex flex-col gap-14 relative">
            ...
            <div className="gap-2 gap-y-6 flex flex-col md:flex-row justify-between">
              <div className="gap-2 flex flex-col order-2 md:order-1">
                <BlurFadeText
                  ...
                  className="text-3xl font-semibold tracking-tighter sm:text-5xl lg:text-6xl"
                  yOffset={8}
                  text={`Hi, I'm ${DATA.shortName} 👋🏾`}
                />
                <BlurFadeText
                  className="max-w-[600px]  lg:text-xl"
                  delay={BLUR_FADE_DELAY}
        ...
        <section id="about" className="w-full max-w-2xl mx-auto">
        ...
        <section id="education" className="w-full max-w-2xl mx-auto">
          <div className="flex min-h-0 flex-col gap-y-4">
        ...
        <section id="certifications" className="w-full max-w-2xl mx-auto">
          <div className="flex min-h-0 flex-col gap-y-4">
        ...
        <section id="skills" className="w-full max-w-2xl mx-auto">
          <div className="pt-4">
            <div className="flex min-h-0 flex-col gap-y-4">
                  ...
                  <BlurFade key={skill.name} delay={BLUR_FADE_DELAY * 11 + id * 0.05}>
                    <div className="border bg-background border-border ring-2 ring-border/20 rounded-xl h-10 w-fit px-4 flex items-center gap-2">
                      {skill.icon && (
                        ...
                        <img src={skill.icon} alt={skill.name} className="size-6 rounded overflow-hidden object-contain" />
                      )}
